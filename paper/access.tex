...
\item
  ...
  \item
    \(\operatorname{\sigma_{2, s, n} = \sbullet}\), the SP is in a neutral position because the package has not brought her any value and she did not put any effort to provide the service yet
  \end{itemize}
\item
  Starting a dispute:
